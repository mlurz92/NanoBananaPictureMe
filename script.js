...
const LoadingCard = ({ era, isPolaroid = true, showLabel = true }) => {
    ...
    return React.createElement("div", { className: containerClass },
        ...
        isPolaroid && showLabel && React.createElement("div", { className: "absolute bottom-3 left-0 right-0 flex justify-center" },
            React.createElement(SkeletonLoader, { className: "h-6 w-3/4 rounded-md bg-gray-300" })
        ),
        !isPolaroid && showLabel && React.createElement("div", { className: "mt-3 flex justify-center" },
...
const ErrorNotification = ({ message, onDismiss }) => {
    ...
    return React.createElement("div", { className: "fixed top-5 left-1/2 z-50 w-full max-w-md p-4 bg-gray-900 border border-gray-700 text-gray-300 rounded-lg shadow-2xl flex items-center justify-between animate-fade-in-down", style: { transform: 'translateX(-50%)' } },
...
const RadioPill = ({ name, value, label, checked, onChange }) => React.createElement("label", { className: `cursor-pointer px-3 py-1.5 text-sm rounded-full transition-colors font-semibold ${checked ? 'bg-yellow-400 text-black' : 'bg-gray-800 hover:bg-gray-700 text-gray-300'}` },
...
const TemplateCard = ({ id, name, icon, description, isSelected, onSelect }) => React.createElement("div", {
    onClick: () => onSelect(id),
    className: `cursor-pointer p-5 rounded-xl border-2 transition-all duration-300 transform hover:scale-105 shadow-lg ${isSelected ? 'border-yellow-400 bg-yellow-900/20 ring-1 ring-yellow-400' : 'border-gray-700 bg-gray-900 hover:border-gray-600'}`
},
...
const App = () => {
    ...
    const AlbumDownloadButton = () => {
        ...
        return React.createElement("div", { className: "relative", ref: menuRef },
            ...
            isOpen && !isDownloadingAlbum && React.createElement(motion.div, {
            ...
            React.createElement("div", { className: "w-full max-w-6xl mx-auto" },
                React.createElement("header", { className: "text-center my-12" },
                    React.createElement("h1", { className: "text-6xl md:text-7xl font-caveat text-white tracking-tight" },
                        "Picture",
                        React.createElement("span", { className: "text-yellow-400" }, "Me")
                    ),
                ...
                React.createElement("main", null,
                    React.createElement("div", { className: "bg-gray-900/50 backdrop-blur-sm p-8 rounded-2xl shadow-2xl border border-gray-800 mb-16" },
                        React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10" },
                            React.createElement("div", null,
                                ...
                                uploadedImage && !isUploading && React.createElement("div", { className: "flex flex-col sm:flex-row gap-4 mt-4 w-full" },
                            ...
                            React.createElement("div", null,
                                ...
                                React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8" },
                                    Object.entries(templates).map(([key, data]) => React.createElement(TemplateCard, {
                                        key: key,
                                        id: key,
                                        name: data.name,
                                        icon: data.icon,
                                ...
                                template === 'hairStyler' && React.createElement(motion.div, {
                                    ...
                                    React.createElement("div", null,
                                        ...
                                        React.createElement("div", { className: "flex flex-wrap gap-3" },
                                            templates.hairStyler.prompts.map(prompt => React.createElement("button", {
                                                key: prompt.id,
                                                onClick: () => handleHairStyleSelect(prompt.id),
                                                className: `cursor-pointer px-3 py-1.5 text-sm rounded-full transition-colors font-semibold ${selectedHairStyles.includes(prompt.id) ? 'bg-yellow-400 text-black' : 'bg-gray-800 hover:bg-gray-700 text-gray-300'}`
                                            }, prompt.id)),
                                            React.createElement("button", {
                                                onClick: () => handleHairStyleSelect('Other'),
                                                className: `cursor-pointer px-3 py-1.5 text-sm rounded-full transition-colors font-semibold ${isCustomHairActive ? 'bg-yellow-400 text-black' : 'bg-gray-800 hover:bg-gray-700 text-gray-300'}`
                                            }, "Other...")
                                        )
                                    ),
                                    isCustomHairActive && React.createElement(motion.div, {
                                    ...
                                    React.createElement("div", null,
                                        ...
                                        React.createElement("div", { className: "flex items-center gap-4 flex-wrap" },
                                            hairColors.map((color, index) => React.createElement(motion.div, {
                                                key: index,
                                            ...
                                            hairColors.length < 2 && React.createElement("button", {
                                        ...
                                        hairColors.length > 0 && React.createElement("button", { onClick: () => setHairColors([]), className: "text-xs text-gray-500 hover:text-white transition-colors mt-3" }, "Clear all colors")
                                    )
                                ),
                                template === 'headshots' && React.createElement(motion.div, {
                                    initial: { opacity: 0, height: 0 },
                                    animate: { opacity: 1, height: 'auto' },
                                    transition: { duration: 0.3 },
                                    className: "p-6 border border-gray-700 rounded-xl space-y-6 bg-gray-800/50"
                                ...
                                template === 'styleLookbook' && React.createElement(motion.div, {
                                    initial: { opacity: 0, height: 0 },
                                    animate: { opacity: 1, height: 'auto' },
                                    transition: { duration: 0.3 },
                                    className: "p-6 border border-gray-700 rounded-xl space-y-6 bg-gray-800/50"
                                    ...
                                    React.createElement("div", null,
                                        React.createElement("div", { className: "flex flex-wrap gap-3" },
                                            templates.styleLookbook.styles.map(style => React.createElement(RadioPill, {
                                                key: style,
                                                name: "style",
                                                value: style,
                                                label: style,
                                    ...
                                    lookbookStyle === 'Other' && React.createElement(motion.div, {
                                        initial: { opacity: 0, y: -10 },
                                        animate: { opacity: 1, y: 0 }
                                    },
                                        React.createElement("label", { className: "block text-sm font-medium text-gray-400 mb-2" }, "Your Custom Style"),
                    ...
                    React.createElement("div", { ref: resultsRef },
                        isSettingUp && React.createElement("div", { className: "text-center my-20 flex flex-col items-center p-10 bg-gray-900/70 rounded-2xl" },
                        ...
                        (isLoading || generatedImages.length > 0) && !isSettingUp && React.createElement("div", { className: "mt-16" },
                            React.createElement("h2", { className: "text-3xl font-bold text-white mb-8 text-center" }, "Your Generated Photos"),
                            isLoading && React.createElement("div", { className: "w-full max-w-4xl mx-auto mb-8 text-center" },
                        ...
                        !isLoading && generatedImages.length > 0 && React.createElement("div", { className: "text-center mt-16 mb-12 flex justify-center gap-6" },
